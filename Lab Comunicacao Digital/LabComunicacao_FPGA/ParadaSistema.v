module ParadaSistema(clock,pausa,botaoIN,status,enter,reset);
  ...
  always@(pausa)
	...
	always@(posedge clock) begin
		 if (reset) estadoAtual <= 2'b00;  // parâmetro reset precisaria ser adicionado
		 else if (botaoIN | enter) estadoAtual <= 2'b10;
