...
void loop() {
  ...
  if(porcentagemPot < 26){ intensidadeluminosa = 0; } 
  else if(porcentagemPot < 51){ intensidadeluminosa = 25; }
  else if(porcentagemPot < 76){ intensidadeluminosa = 50; } 
  else if(porcentagemPot < 100){ intensidadeluminosa = 75; } 
  else { intensidadeluminosa = 100; }
