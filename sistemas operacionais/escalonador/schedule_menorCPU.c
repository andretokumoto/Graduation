...
#define SCHEDULE_CHANGE_MIN_CPU	0x4
...
{
	int err;
	int new_prio, new_quantum, new_cpu, niced, new_cpuPrio;
	...
	if (flags & SCHEDULE_CHANGE_MIN_CPU)
		new_cpuPrio = rmp->cpu_min;
	else
		new_cpuPrio--;	
